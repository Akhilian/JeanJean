<template>
  <sec class="text-center grid gap-8">
    ...
    <p class="font-medium text-2xl text-xl">
      Un menu rythmé par les saisons, des plats conçus sous vos yeux à partir de produits bruts sourcés avec soin.
    </p>
    <p class="font-medium text-2xl text-xl">
      Une sélection de vin au verre et à la bouteille dénichée au fil des rencontres de vignerons passionnés.
    </p>
  </sec>
</template>
